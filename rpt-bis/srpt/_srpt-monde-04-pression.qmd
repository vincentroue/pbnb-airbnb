...
La pression par habitant ne se mesure pas en volumes bruts. En médiane, la pression atteint **`r aa$v_pression_med` annonces pour 1 000 habitants** dans la zone dense. Mais `r aa$t_top_pression` atteint **`r aa$v_top_pression` ‰** quand `r aa$t_bot_pression` reste à **`r aa$v_bot_pression` ‰** — un facteur `r aa$v_facteur_pression`.
